...
/* epilogue start for Diagonal_Move */
    ...
    .text
.global Diagonal_incX
    .type  Diagonal_incX, @function
Diagonal_incX:
    push   r29
    push   r28
    # make space for locals and params
    ...
    std    Y + 1, r24
    std    Y + 3, r22
/* done with function Diagonal_incX prologue */
...
/* epilogue start for Diagonal_incX */
    # handle return value
    # load a two byte expression off stack
    pop    r24
    pop    r25
    ...
    pop    r29
    ret
    .size Diagonal_incX, .-Diagonal_incX
